...
public class ReflectTestProto {
    ...
    public void testReflectTime() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ReflectTestProto reflectTest = new ReflectTestProto();
        TestParam testParam = new TestParam();
        testParam.setType(100);

        Class<?> clazz = ReflectTestProto.class;
    ...
    public void testStaticClass() {
        ...
        // 静态代码生成一个代理类
        Class<?> handleClazz = ReflectTestProto.class;
