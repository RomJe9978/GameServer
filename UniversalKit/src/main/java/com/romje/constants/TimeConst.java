...
public class TimeConst {
     ...
     * 每毫秒多少纳秒
     */
    public static final int NANOS_OF_MILLI = 1000 * 1000;
     ...
     * 每分钟多少毫秒
     */
    public static final int MILLIS_OF_MINUTE = 60 * 1000;
     ...
     * 每周多少小时
     */
    public static final int HOURS_OF_WEEK = 7 * 24;

    /**
     * 每周多少分钟
     */
    public static final int MINUTES_OF_WEEK = 7 * 24 * 60;

    /**
     * 每周多少秒
     */
    public static final int SECONDS_OF_WEEK = 7 * 24 * 60 * 60;

    /**
     * 每周多少毫秒
     */
    public static final int MILLIS_OF_WEEK = 7 * 24 * 60 * 60 * 1000;
}
